...
import com.lianxi.dingtu.dingtu_urovo.di.component.DaggerLoginComponent;
import com.lianxi.dingtu.dingtu_urovo.mvp.contract.LoginContract;
import com.lianxi.dingtu.dingtu_urovo.mvp.presenter.LoginPresenter;
...
public class LoginActivity extends BaseActivity<LoginPresenter> implements LoginContract.View {
    ...
    @OnClick({R.id.iv_clean_phone, R.id.clean_password, R.id.iv_show_pwd, R.id.cbIsRememberPass, R.id.btn_login}) public void onViewClicked(View view) {
        switch (view.getId()) {
