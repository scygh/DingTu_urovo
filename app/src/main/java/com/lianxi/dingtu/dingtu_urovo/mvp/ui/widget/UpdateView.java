...
import com.lianxi.dingtu.dingtu_urovo.app.api.UpdateCenterService;
import com.lianxi.dingtu.dingtu_urovo.app.entity.UpdateInfo;
import com.lianxi.dingtu.dingtu_urovo.mvp.ui.widget.UpdateConfig;
...
//            String verjson = getContent("http://machine_api.dt128.com/Api/VersionRepository/Highest?operatingSystem=android&type=em&extensionName=.apk");
            ...
            Call<UpdateInfo> call = ArmsUtils.obtainAppComponentFromContext(mContext).repositoryManager().obtainRetrofitService(UpdateCenterService.class).syncUpdate("Android_urovoEM");
